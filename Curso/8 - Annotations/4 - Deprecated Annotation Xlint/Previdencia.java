/*
    A flag de compilação -Xlint:deprecation mostra em detalhes o uso de recursos defasados no código,
    desde que tais recursos estejam indicados com @Deprecated.

    Compilação: javac ./Previdencia.java -Xlint:deprecation
*/
